...
namespace CodingInterview.MyLearnings
{
    ...
    8. Full binary tree is the binary tree which has maximum 2 child nodes or 0 nodes.
    9. Complete binary tree is the binary tree which not have any blank or null nodes in between.
    10. A full binary tree is always complete binary.
    11. A compleate binary its need not be a full binary tree.
    */
